...
(function (global) {
  ...
  var SOLO_SPEC = {
    ...
    pastbond: '전생에서 이어져 온 인연을 읽는다. 공망 자리, 일지와 월지의 합충, 도화·홍염·화개, 배우자성의 상태로 "이번 생에 다시 만나기로 되어 있는 사람"의 결을 묘사한다. 갚아야 할 빚 같은 인연과 받으러 온 인연을 구분해서 말하고, 그 인연이 어떤 상황에서 나타나는지 장면으로 그린다. 800자 이상.'
  };
  ...
  var PAIR_SECTIONS = [
    ...
    { id: 'p_past', title: '전생의 모습과 전생의 인연', el: 4 },
  ...
  var PAIR_SPEC = {
    ...
    p_past: '전생에서 이 둘이 어떤 관계였는지를 일주·합충·공망·화개로 읽어 하나의 장면으로 쓴다. 그때 못 끝낸 것이 이번 생에 어떤 상황으로 재현되는지 연결한다. 소설처럼 쓰되 명식 근거를 문장에 넣어라. 800자 이상.',
