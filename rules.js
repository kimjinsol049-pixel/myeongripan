...
(function (global) {
  ...
  /* ---------- 공개 ---------- */
  global.Rules = {
    solo: function (R, id) { try { return SOLO[id] ? SOLO[id](R) : ''; } catch (e) { return ''; } },
    pair: function (A, B, C, id) { try { return PAIR[id] ? PAIR[id](A, B, C) : ''; } catch (e) { return ''; } },
    group: function (list, G, id) { try { return GROUP[id] ? GROUP[id](list, G) : ''; } catch (e) { return ''; } }
  };
